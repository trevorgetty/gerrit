...
public class DiffPreferences extends JavaScriptObject {
  ...
  public final native void intralineDifference(Boolean i) /*-{ i = this.intraline_difference || false; }-*/;
  public final native void showLineEndings(Boolean s) /*-{ s = this.show_line_endings || false }-*/;
  public final native void showTabs(Boolean s) /*-{ s = this.show_tabs || false }-*/;
  public final native void showWhitespaceErrors(Boolean s) /*-{ s = this.show_whitespace_errors || false }-*/;
  public final native void syntaxHighlighting(Boolean s) /*-{ s= this.syntax_highlighting || false }-*/;
  public final native void hideTopMenu(Boolean s) /*-{ s= this.hide_top_menu || false }-*/;
  public final native void autoHideDiffTableHeader(Boolean s) /*-{ s = this.auto_hide_diff_table_header || false }-*/;
  public final native void hideLineNumbers(Boolean s) /*-{ s = this.hide_line_numbers || false }-*/;
  public final native void expandAllComments(Boolean e) /*-{ e = this.expand_all_comments || false }-*/;
  public final native void manualReview(Boolean r) /*-{ r = this.manual_review || false }-*/;
  public final native void renderEntireFile(Boolean r) /*-{ r = this.render_entire_file || false }-*/;
  public final native void retainHeader(Boolean r) /*-{ r = this.retain_header || false }-*/;
  public final native void hideEmptyPane(Boolean s) /*-{ s = this.hide_empty_pane || false }-*/;
  public final native void skipUnchanged(Boolean s) /*-{ s = this.skip_unchanged || false }-*/;
  public final native void skipUncommented(Boolean s) /*-{ s = this.skip_uncommented || false }-*/;
  public final native void skipDeleted(Boolean s) /*-{ s = this.skip_deleted || false }-*/;
  public final native void matchBrackets(Boolean m) /*-{ m = this.match_brackets || false }-*/;
  public final native void lineWrapping(Boolean w) /*-{ w = this.line_wrapping || false }-*/;
